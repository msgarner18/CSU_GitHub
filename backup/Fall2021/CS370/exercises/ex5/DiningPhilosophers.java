//needs DiningPhilosophers.java (this) creates and starts threads
//PhilosopherTable.java  has pickup( ) putdown() and test()
//PhilosopherThread.java a thread for each philosopher
// from Case Western Reserve Univ

public class DiningPhilosophers {

    public static final int PHILOSOPHERS = 5; // 5 philosophers
    public static final long DURATION = 500/* ms */;

    /*
     * Two optional arguments: 1st argument: number of philosophers 2nd argument:
     * duration in seconds
     */
