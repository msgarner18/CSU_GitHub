...
NegativeOne        .FILL #-1 ;MinusOne        .FILL #-1
...
Factorial       
                ...
                ;__________________ ; Step 3: allocate space for return value
...
Checkpoint1     LDR   R0, R5, #4    ; Load parameter N into a register
                ...
                LD    R1, NegativeOne  ; Calculate N - 1
...
Finish
                POP R2              ; Step 9: remove local variable from stack  ?
                ADD R5, R5, #4      ; Step 10: restore previous frame pointer   ?
                ;LDR R7, R6, #1      ; Step 11: restore return address           ?
